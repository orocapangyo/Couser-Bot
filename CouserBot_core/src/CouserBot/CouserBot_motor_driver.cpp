...
{
  torque_ = false;
  limit_max_velocity_ = DCMOTOR_LIMIT_MAX_VELOCITY;
}
...
bool CouserBotMotorDriver::runMotor(int64_t left_value, int64_t right_value)
{
  ...
  LMotor->setSpeed(left_value);
  RMotor->setSpeed(right_value);
...
bool CouserBotMotorDriver::setTorque(bool onoff)
{
  uint8_t dxl_error = 0;
